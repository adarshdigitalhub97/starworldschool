...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Star World School — Admissions Open 2026-27" },
      { property: "og:description", content: "Where Every Child Shines Like A Star. 40+ years of excellence in early childhood education in Indore." },
